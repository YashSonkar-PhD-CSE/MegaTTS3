...
if __name__ == '__main__':
    ...
    wav_path, input_dir, out_path, time_step, p_w, t_w = args.input_wav, args.input_dir, args.output_dir, args.time_step, args.p_w, args.t_w
    ...
    for input_file in textFiles:
        ...
        print(f"| Start processing {wav_path}+{input_text}", flush=True)
